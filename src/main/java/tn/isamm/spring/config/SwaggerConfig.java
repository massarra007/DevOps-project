package tn.isamm.spring.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("tn.isamm.spring")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "com.esprit.examen".
